<!DOCTYPE html>
    ...
    <body>
        ...
        <div class = "container mt-4">
            <form action = "Add_Classroom.php?command=update&classcode=<?php echo $_REQUEST['classcode'];?>&teachername=<?php echo $result['Teacher_Name'];?>" method = "post" enctype = "multipart/form-data">
            <input type = "text" placeholder = "Enter classroom name" class = "form-control input border border-dark" required name = "classname" value = "<?php if(isset($_REQUEST['teacher']) or isset($_REQUEST['status'])){echo $_REQUEST['classname'];} else if(isset($_REQUEST['classcode'])) {echo $result['Class_Name']; }?>">
            <br> <br>
    
            <input type = "text" placeholder = "Enter teacher name" class = "form-control input border border-dark" required name = "teachername" value = "<?php if(isset($_REQUEST['teacher']) or isset($_REQUEST['status'])){echo $_REQUEST['teacher']; } else if(isset($_REQUEST['classcode'])) {echo $result['Teacher_Name']; }?>" disabled>
            ...
            <input type = "text" placeholder = "Enter class code" class = "form-control input border border-dark" required name = "classcode" value = "<?php if(isset($_REQUEST['teacher']) or isset($_REQUEST['status'])){echo $_REQUEST['classcode']; } else if(isset($_REQUEST['classcode'])) {echo $classcode; }
