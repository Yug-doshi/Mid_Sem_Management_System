...
include("validate_login.php");
    ...
    $result = mysqli_query($con,"select * from classroom_for_teacher");
?>
<body>
    ...
    <?php 
        while($row = mysqli_fetch_array($result)){
            ...
            <div class = "classroom ms-5 mb-4">
                ...
                <a href = "Delete_classroom.php?classcode=<?php echo $row['Class_code'] ?>"><img src = "images/delete.png" height = "40" class = "ms-3 mt-3"></a>
                <a href = "Update_classroom.php?classcode=<?php echo $row['Class_code'];?>"><img src = "images/refresh-page-option.png" height = "40" class = "ms-4 mt-3 icon"></a>
                </div> 
            </div>
            <?php
        }
